...
FFile.prototype = {
    ...
    funUploadFile: function () {
        ...
        floorprice = $('#goods_floorprice').val();
        ...
        $.post('/publish_auction/', {
            ...
            if (data.msg === 'ok') {
                location.href = '/release_auction_ok/'
            } else if (data.msg === 'title.length_error') {
                $('#error_message').html(function () {

                    document.getElementById('error_message').style.display = 'block'
                    document.getElementById('error_message').innerText = "标题不得少于6位数";
                })
            } else if (data.msg === 'less_error') {

                $('#error_message').html(function () {
                    document.getElementById('error_message').style.display = 'block';
                    document.getElementById('error_message').innerText = '必须全部输入';
                })

            } else if (data.msg === 'price_error') {
                $('#error_message').html(function () {
                    document.getElementById('error_message').style.display = 'block';
                    document.getElementById('error_message').innerText = '商品最低加价和底价必须为整数';
